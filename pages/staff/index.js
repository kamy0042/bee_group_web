                        ...
                        <section className={styles.voice}>
                            ...
                            <div className={styles.voice_body}>
                                <ul className={styles.voice_list}>
                                    <li>
                                        <p>
                                        初めて美容室を訪れた時に、自分に似合う髪型が分からず、どうリクエストしていいかも分かりませんでした。メンズショートで立ち上げる感じのヘアスタイルにしていただき、自分でもビックリするほど印象が変わりました。家族や友人からも喜んでもらえたのが嬉しくて、これからは少しオシャレに気を使ってみようと思っています。今後ともよろしくお願いします！（20代　大学院生）                                        </p>
                                    </li>
                                </ul>
                            </div>
                        </section>
