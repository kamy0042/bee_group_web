        ...
        <div className={styles.contents}>
          <section className={`${utilStyles.section}`}>
            ...
            <div className={styles.staff}>
              <StaffProfile
                className="ikoma"
                position="スタイリスト・エステティシャン（認定脱毛士）"
                staffName="生駒 明子"
                ...
                message="ヘアスタイリストの技術に加えて、認定脱毛士としてメンズ脱毛の施術も担当し、髪と肌のトータルケアをサポートしています。信頼感を与えるヘアスタイルから、ムダ毛ケアによる清潔感ある印象づくりまで、お客様一人ひとりにの魅力を最大限に引き出します。脱毛が初めての方や施術に不安を感じる方にも寄り添い、丁寧な施術をお約束します。"
              />
            </div>
          </section>
