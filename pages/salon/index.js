                ...
                <section>
                            ...
                            <div className={styles.shopInfo_textArea}>
                                <div className={styles.shopInfo_address}>
                                    <p>
                                        ...
                                        <span>
                                            タバコ（煙草）売り場のあるビルの地下１階です。　新橋駅、汐留駅、御成門駅から
                                        </span>
                    ...
                    <section className={styles.message}>
                        ...
                        <p className={styles.message_text}>
                            “bee”とは　よく知られている「蜂」という意味のほかに、「働く人、隣人や友人の寄り合い」という意味もあります。私たちは、忙しく働く男性お一人おひとりに「魅力と自信」に満ち溢れ、こころ豊かな日常を送っていただくことをコンセプトに、『今までで、１番』　のサービスを、友人や隣人のような身近な存在として、お届けしてまいります。さらに、あなたの家族、友人、恋人にも「今までで１番、いいね」と認めてもらい、あなただけでなくあなたに関わるすべての方々のこころも豊かにするご提案をさせて頂きます。
                        </p>
