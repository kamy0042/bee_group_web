          ...
          <dd>
            <ul>
              <li>
                ...
                <span>【9月の店休日】9/10 (日)</span>
              </li>
              <li>
                <span>2023.08.20</span>
                <a href="/news/news_230818.pdf" target="_blank">
                  メンズ脱毛開始のお知らせ
                </a>
              </li>
              <li>
        ...
        <div className={styles.contents}>
          ...
          <section className={`${styles.salon} ${styles.section}`}>
            ...
            <Merit
              ...
              num="05"
              title={`眉毛＆髭のデザインまで\nトータルコーディネート`}
              text="男の身だしなみ、さりげないオシャレに必須となったメンズの眉毛ケア。だけど眉毛の整え方が分からない…そのお悩みもBee dandyで解決できます。１秒で好印象、100％好かれる眉毛にはコツがあります。形の整え方、薄眉のカバー、バレない眉メイクまで、プロがアドバイスしますので全てお任せください。"
              // link="/menu/removal/"
            />
          </section>
