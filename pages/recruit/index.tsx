      ...
      <div className={styles.contents}>
        <section>
          ...
          <div className={styles.headerCopy}>
            ...
            <p className={styles.star}>毎月2回の日曜店休／1週間の連休取得もOK</p>
          </div>
        </section>
        ...
        <div className={styles.section}>
            ...
            <div className={styles.descriptionContent}>
              ...
              <div className={styles.descriptionTextArea}>
                <dl className={styles.descriptionInner}>
                  ...
                  <dt>・ 安定してしっかり稼げます！</dt>
                  <dd>新規集客は月４０人以上。入社してもカットする機会がないとか、集客や営業のノルマを押し付けるようなことはありません。</dd>
          ...
          <section className={styles.description}>
            ...
            <dl className={`${styles.descriptionInner}, ${styles.recruitDetail}`}>
              ...
              <dd>詳細は<a className={styles.lightLink} target="_blank" href='https://work.beauty.hotpepper.jp/WC00004323/WS0000011338/JP0000003373/?wak=BPCO100001_rsvButton_salon_kyujin' rel="noreferrer">こちら</a>
                をご覧ください</dd>
              <dt>教育・研修制度</dt>
              <dd>
