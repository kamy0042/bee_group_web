    ...
    <MainLayout noHeaderImg isLight>
      <div className={styles.contents}>
        ...
        <div className={styles.message}>
          ...
          <p>「皆さんが想像している新橋エリアの顧客イメージとはまったく違います！」</p>
          <p>お客様にはエグゼクティブやハイクラス層が多く、客単価も高いです。ふだん会うことがないような方との人脈もできます。</p>
          <p>自分の知らなかった世界や、美容師の可能性の広がりがBee dandyにはあります。</p>
          <p>あなたのセンスとスキルを待ち望んでいるビジネスマンがたくさんいます。</p>
        ...
        <div className={styles.section}>
          <section className={styles.description}>
            ...
            <div className={styles.descriptionContent}>
              <div>
                <p>
                  日曜の店休日、１週間の有給連続取得、休憩時間の確保、業務時間内の研修など、一般企業と同じように残業や長時間労働の削減に積極的に取り組んでいます。
                </p>
                <p>働きやすい環境で、友人や家族との旅行やお子様の行事参加など、プライベートも充実させてください！</p>
            ...
            <div className={styles.descriptionContent}>
              ...
              <div className={styles.descriptionTextArea}>
                <dl className={styles.descriptionInner}>
                  ...
                  <dt>・ 安定してしっかり稼げます！</dt>
                  <dd>月給に加えて、指名料を100％還元します。新規集客は月４０人以上。入社してもカットする機会がないとか、集客や営業のノルマを押し付けるようなことはありません。</dd>
                ...
                <dl className={styles.descriptionInner}>
                  ...
                  <dd>
                    ...
                    <p>
                      ...
                      月給 230,000円＋売上歩合 140,000円＋各種手当 60,000円＝支給額 430,000円
                    </p>
          ...
          <section className={styles.description}>
            ...
            <div className={styles.descriptionContent}>
              ...
              <div className={styles.descriptionTextArea}>
                ...
                <p>今後はメンズだけでなく、レディースの展開も視野に入れて、10店舗の展開を目指している美容室です。</p>
              ...
              <dd>
                ...
                <dl className={styles.descriptionInner}>
                  <dd className={styles.withIcon}>
                    <span className={styles.icon}>＋指名料売上</span>：100%還元
                  </dd>
                  <dd className={styles.withIcon}>
                    <span className={styles.icon}>店販売上</span>：10%還元
                  </dd>
                  <dd className={styles.withIcon}>
                    <span className={styles.icon}>技術売上</span>：50万円を超える売上高から10～20%還元
                  </dd>
                </dl>
                <h4 className={styles.descriptionInnerHeading}>手当</h4>
                <ul>
