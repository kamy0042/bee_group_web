                ...
                <div className={styles.contents}>
                    ...
                    <section className={`${styles.salon} ${styles.section}`}>
                        ...
                        <Merit
                            ...
                            num="05"
                            title={`ヘアカットのついでに\n脱毛も可能`}
                            text="毎日のひげ剃りを楽にしたい、手や脚の毛を嫌がられない程度に薄くしたい・・・でも脱毛サロンへ通うのはハードルが高い、そもそも脱毛について聞くこと自体が恥ずかしいというのが本音ではないでしょうか。男の身だしなみ、さりげないオシャレに必須となったメンズのグルーミング。ツルツルだけでなく、エチケット程度に毛量を減らしたり、毛の生え方をデザインすることもできるので、ぜひご希望をお伝えください。※脱毛のご提供は2021年度中に開始予定です。"
                            // link="/menu/removal/"
                        />
                    </section>
