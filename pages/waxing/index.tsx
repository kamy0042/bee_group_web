        ...
        <div className={styles.contents}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.menu_textArea}>
              <p>ツルツルだけでなく、エチケット程度に毛量を減らしたり、毛の生え方をデザインすることもできます。各部位、1回の施術ごとのお支払いだから安心。自分が脱毛を止めたい時に止められ、始めたい時に始められます。</p>
              <p>年会費をお支払いいただくことで、一般料金よりお得な会員料金で施術を受けられます。<br/>自分が脱毛を止めたい時に止められ、始めたい時に始められます。</p>
            </div>
          ...
          <section className={`${styles.menu} ${styles.section}`}>
            ...
            <div className={styles.faq_wrapper}>
              ...
              <dl>
                ...
                <dd className={styles.faq_body}>
                  <p>
                    必要な回数はお一人おひとり、かなり個人差があり、毛量・密度、部位、目的などによって大きく変わりますます。ヒゲの場合は一般的に5〜6回目の施術で効果を実感される方が多いようです。初回カウンセリング時に効果の出てくる時期と回数の目安が見えてきますので、ぜひご相談ください。
                  </p>
                </dd>
