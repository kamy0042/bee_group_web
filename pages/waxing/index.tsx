        ...
        <div className={styles.contents}>
          <section className={`${styles.section}`}>
            ...
            <div className={styles.concept_textArea}>
              ...
              <p>そこで、ビジネスマン比率90％以上の男性専門美容室に、メンズ脱毛サロンを併設しました。もう、毎朝のひげ剃り、髪のスタイリングに悩まなくていいんです！メンズは頭皮も髪の毛も、そしてお肌も繊細。だから、ヘアスタイル、白髪や毛量、眉毛の手入れ、そしてムダ毛処理まで、一人ひとりの個性に合わせて、あなたのお悩みをカッコよく解決します。</p>
              <div>
          ...
          <section className={`${styles.section}`}>
            ...
            <dl className={styles.salesPoint_wrap}>
              ...
              <div className={styles.salesPoint}>
                ...
                <dd className={styles.salesPoint_text}>
                  脱毛施術を行うのは美容師免許も持つプロの女性スタッフ。髪と肌のトータルケアを実現し、的確なカウンセリングと確かな技術で、心も身体もキレイに！デリケートゾーンの脱毛もご安心ください。（状況により、男性スタッフの場合もございます）
                </dd>
              </div>
                <div className={styles.salesPoint}>
                  <dt className={styles.salesPoint_head}>
          ...
          <section className={`${styles.menu} ${styles.section}`}>
            ...
            <div className={styles.faq_wrapper}>
              ...
              <dl>
                ...
                <dd className={styles.faq_body}>
                  <p>
                    女性の脱毛施術スタッフがおります。男性の生理現象は起こり得るものであると医学的に理解していますので、特に取り乱すようなことはございません。デリケートゾーンの脱毛もご安心ください。状況により、男性スタッフも担当させていただく場合がございます。
                  </p>
                </dd>
